...
/**
 * Strategy: target nuovo, parent nuovo → aggiorna FK_PARENT_NEW_DUCT su r_lines_products.
 */
@Component
public class NewTargetNewParentStrategy implements DuctUpdateStrategy {
    ...
    public RowUpdateData buildUpdate(Long targetId, Long parentId) {
        return RowUpdateData.of(RLinesProducts.S_PK_COLUMN_NAME, targetId)
                .set(RLinesProducts.S_FK_PARENT_NEW_DUCT, parentId);
    }
}
